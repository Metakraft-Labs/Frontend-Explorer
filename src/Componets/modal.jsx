     ...
     >
       <div className="modale" onClick={(e) => e.stopPropagation()}>
         <header className="modal_header">
           ...
           <svg className="close" onClick={() => close()} xmlns="http://www.w3.org/2000/svg" width='3vw' height='3vw' style={{cursor:'pointer',fill:'#01C5BA'}} viewBox="0 0 384 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/></svg>
         </header>
           ...
           <main className="modal_content">
            <div style={{width:'100%',padding:'0 11vw'}}>
                <div style={{display:'flex'}}>
                    <div style={{fontSize:'1.1vw',color:'white',fontWeight:'700'}}>Levels</div>
                    <div style={{display:'flex',gap:'0.6vw',paddingLeft:'8vw'}}>
                    <svg width="1.389vw" height="1.38vw" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.5" y="0.5" width="21" height="21" rx="10.5" fill="white"/>
                    <g clipPath="url(#clip0_598_112)">
                    <path d="M14 9H13.5V8C13.5 6.62 12.38 5.5 11 5.5C9.62 5.5 8.5 6.62 8.5 8V9H8C7.45 9 7 9.45 7 10V15C7 15.55 7.45 16 8 16H14C14.55 16 15 15.55 15 15V10C15 9.45 14.55 9 14 9ZM11 13.5C10.45 13.5 10 13.05 10 12.5C10 11.95 10.45 11.5 11 11.5C11.55 11.5 12 11.95 12 12.5C12 13.05 11.55 13.5 11 13.5ZM9.5 9V8C9.5 7.17 10.17 6.5 11 6.5C11.83 6.5 12.5 7.17 12.5 8V9H9.5Z" fill="black"/>
                    </g>
                    ...
                    <rect width="12" height="12" fill="white" transform="translate(5 5)"/>
                        ...
                        <div style={{fontSize:'0.97vw',color:'white',fontWeight:'500'}}>BRONZE</div>
                    </div>
                    <div style={{display:'flex',gap:'0.6vw',paddingLeft:'4vw'}}>
                    <svg width="1.389vw" height="1.38vw" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.5" y="0.5" width="21" height="21" rx="10.5" fill="white"/>
                    <g clipPath="url(#clip0_598_112)">
                    <path d="M14 9H13.5V8C13.5 6.62 12.38 5.5 11 5.5C9.62 5.5 8.5 6.62 8.5 8V9H8C7.45 9 7 9.45 7 10V15C7 15.55 7.45 16 8 16H14C14.55 16 15 15.55 15 15V10C15 9.45 14.55 9 14 9ZM11 13.5C10.45 13.5 10 13.05 10 12.5C10 11.95 10.45 11.5 11 11.5C11.55 11.5 12 11.95 12 12.5C12 13.05 11.55 13.5 11 13.5ZM9.5 9V8C9.5 7.17 10.17 6.5 11 6.5C11.83 6.5 12.5 7.17 12.5 8V9H9.5Z" fill="black"/>
                    ...
                    <rect width="12" height="12" fill="white" transform="translate(5 5)"/>
                        ...
                        <div style={{fontSize:'0.97vw',color:'white',fontWeight:'500'}}>SILVER</div>
                    </div>
                    <div style={{display:'flex',gap:'0.6vw',paddingLeft:'8vw'}}>
                    <svg width="1.389vw" height="1.38vw" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.5" y="0.5" width="21" height="21" rx="10.5" fill="white"/>
                    ...
                    <rect width="12" height="12" fill="white" transform="translate(5 5)"/>
                        ...
                        <div style={{fontSize:'0.97vw',color:'white',fontWeight:'500'}}>GOLD</div>
                    </div>
                </div>
                <div style={{paddingTop:'1.04vw',display:'flex',fontSize:'0.83vw',color:'white',fontWegiht:'500'}}>
                    <div>0</div>
                    <div style={{paddingLeft:'12.7vw'}}>10</div>
                    <div style={{paddingLeft:'8.8vw'}}>70</div>
                    <div style={{paddingLeft:'12.5vw'}}>200</div>
                </div>
                <div style={{display:'flex',justifyContent:'space-around',padding:'0 2vw',width:'36.94vw',height:'0.69vw',borderRadius:'0.35vw',background:'#D5D9E7'}}>
            ...
            <div style={{fontSize:'1.38vw',color:'white',fontWeight:'500',padding:'0.2vw'}}>Vouchers & Rewards worth $1K</div>
            </div>
            </div>
           </main>
           <footer className="modal_footer">
