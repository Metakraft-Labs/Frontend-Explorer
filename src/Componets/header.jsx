...
function Header() {
 ...
 useEffect(()=>{
  ...
  buttonList[1].addEventListener('mouseleave',function(event){
...
//  }
  ...
  <div id="alpha" style={{position:'absolute',top:"3.5vw",left:"31vw",backgroundColor:"#1b1b1b",height:"10vw",width:"8vw",borderRadius:"0.7vw",display:`${panel[1]}`,fontSize:'1.11vw',color:'#9c9c9c',border:'1px solid #9c9c9c',textAlign:'center'}}>
    <div style={{paddingTop:'1vw',cursor:'pointer'}}> <a href="https://linktr.ee/metakraft" style={{textDecoration:'none',color:'#9c9c9c'}}>Creators</a></div>
  ...
  <div style={{position:'absolute',top:"5vw",left:"47vw",backgroundColor:"#1b1b1b",height:"30vw",width:"20vw",borderRadius:"0.7vw",display:`${panel[4]}`}}></div> */}
    <div className="navi" style={{display:"flex",flexDirection:"row",width:"100%",justifyContent:"space-evenly"}}> 
      <img style={{marginTop:"0.5vw",height:"2.5vw"}}src={Picture12} alt="not found" onClick={()=>navigate('/')}/>
      <div style={{display:"flex",paddingLeft:"9%",fontSize:"0.9vw"}}>
          ...
          <div  className="navButton"  href="#" style={{cursor:'pointer',color:"#C4C4C4"}}>
            Discover
          </div>
          <div className='navButton' onClick={(event)=>{showSpeed(event,"about")}} href="#" style={{cursor:'pointer',color:"#C4C4C4"}}>About Us</div>
          <div className='navButton' style={{cursor:'pointer',color:"#C4C4C4",textDecoration:'none'}}>
            <a href='https://blog.metakraft.live/' style={{textDecoration:'none',color:'#C4C4C4'}}>
            Blog
            </a>
            </div>
